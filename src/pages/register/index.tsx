...
const Register = () => {
    ...
    const onFinish: FormProps<FieldType>['onFinish'] = (values) => {
        ...
        register.mutate(values, {
            onSuccess: () => {
                dispatch(setLoginData({ email: values.email }))
                navigate('/verify-otp')
            }
        })
    };
        ...
        <div className='bg-black dark:bg-white'>
            <div className='container flex flex-col h-screen items-center'>
                <div className='mt-12 mb-8 text-center flex flex-col gap-4'>
                    <h2 className='text-white dark:text-black text-[32px]'>Register</h2>
                    <p className='text-[#777777]'>Register to access all features</p>
                </div>
                <Form
                    name="basic"
                    style={{ minWidth: 380 }}
                ...
                >
                    ...
                    >
                        <Input className='!p-5.5 !bg-[#111111] dark:!bg-white !border-black dark:!border-[#777777] !text-white dark:!text-black !rounded-xl' placeholder='Enter yout full name' />
                    </Form.Item>
